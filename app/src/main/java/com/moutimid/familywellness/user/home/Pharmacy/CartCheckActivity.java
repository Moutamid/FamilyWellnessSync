...
import com.moutimid.familywellness.Helper.Config;
...
public class CartCheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference z = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("Admin");
            ...
            public void onComplete(@NonNull Task<String> task) {
                ...
                x.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        FirebaseDatabase t = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/");
