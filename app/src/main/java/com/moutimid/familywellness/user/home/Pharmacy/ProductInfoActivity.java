...
//                    PIsFav.setImageResource(R.drawable.ic_baseline_favorite_24);
                    ...
                    DatabaseReference x = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("favourites").child(UserId).child(ProductName);
        ...
        Confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               PriceAfterOffer = (Float) (Float.valueOf(ProductPrice));
                ...
                DatabaseReference x = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("cart").child(UserId);
...
//                startActivity(new Intent(ProductInfoActivity.this, CartActivity.class));
    ...
    private void HandleTotalPriceToZeroIfNotExist() {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("cart").child(UserId).child("totalPrice").setValue("0");
                }
            }
