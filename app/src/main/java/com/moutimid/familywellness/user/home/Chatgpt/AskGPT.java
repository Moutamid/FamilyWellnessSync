package com.moutimid.familywellness.user.home.Chatgpt;
...
import com.moutimid.familywellness.user.adapter.MessageAdapter;
    ...
    private void getResponse(String question) throws JSONException {
        ...
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public Map<String, String> getHeaders() {
                ...
                params.put("Authorization", "Bearer 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");
                return params;
            }
        };
