...
public class EditCatogryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance("gs://childfr-35a43.appspot.com").getReference().child("FamilyWillness").child("categories");
        mdataReference = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("categories");
        ...
        httpsRef.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EditCatogryActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress())
                    Toast.makeText(EditCatogryActivity.this, "Upload Is In Progress", Toast.LENGTH_SHORT).show();
                else {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(EditCatogryActivity.this).setTitle("Confirmation").setMessage("Are You Sure You Want To Save ?!").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
    ...
    public void uploadData()
    {
        ...
        {
            Toast.makeText(EditCatogryActivity.this, "Empty Cells", Toast.LENGTH_SHORT).show();
        }
        else
            uploadImage();
    }
        ...
        else if(imgUri != null)
        {
            ...
            mUploadTask = fileReference.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    CategoryModel man = new CategoryModel(downloadUrl.toString());
                    DatabaseReference z = FirebaseDatabase.getInstance("https://childfr-35a43-default-rtdb.firebaseio.com/").getReference().child("FamilyWillness").child("categories")
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditCatogryActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            });
        }
