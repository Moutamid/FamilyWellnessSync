...
public class AddCatogryActivity extends AppCompatActivity {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress())
                    Toast.makeText(AddCatogryActivity.this, "Upload Is In Progress", Toast.LENGTH_SHORT).show();
                else if (name.getText().toString().isEmpty()) {
                    name.setError("Please Enter");
                } else if (imgUri == null) {

                    Toast.makeText(AddCatogryActivity.this, "Please choose at least one image ", Toast.LENGTH_SHORT).show();

                } else {
                    uploadData();
                    Toast.makeText(AddCatogryActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
        ...
        if (imgUri != null) {
            ...
            mUploadTask = fileReference.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddCatogryActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            });
        }
